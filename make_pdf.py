...
class PDF(FPDF):
    def header(self):
        # Arial bold 15
        self.set_font('TPoppins', 'B', 17)
        # Move to the right
        self.cell(0, 10, 'Shree Raj Marble', border=False, align='L')
        self.line(10, 20, 100, 20)
        self.set_font('Arial', style='', size=14)
        self.ln(10)
        self.cell(0, 10, 'Subhas park,Plot No. 17, Ranjeet sagar road, Jamnagar Gujarat', border=False, align='L')
        self.ln(5)
        self.cell(0, 10, "GST No : "+str(), border=False, align='R')
        self.ln(5)
        self.cell(0, 10, "Mo No : 9712639922", border=False, align='R')
        self.ln(10)
        self.cell(0, 10, "Invoice Number: 123456", border=False, align='L')
        self.ln(5)
        self.cell(0, 10, "Customer Name: Meet Kumar", border=False, align='L')
        self.ln(5)
    ...
    def add_products(self, list_products):
        ...
        for product in list_products:
            ...
            self.cell(40, 6, str(product[2]), 0, 0, 'R')
            self.cell(30, 6, str(product[3]), 0, 0, 'L')
            self.cell(41, 6, str(product[4]), 0, 0, 'R')
            self.ln(5)

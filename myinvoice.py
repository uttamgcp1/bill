...
def getTotal():
    ...
    tex_label = Label(get_total_frame, text="Total tex:", font=("courier", 17))
    tex_label.place(x=350, y=15)
    tex_label_num = Label(get_total_frame, text=getTotal.total_tex, font=("courier", 17))
    tex_label_num.place(x=460, y=15,width=250)

    getTotal.gross_total=round(getTotal.total_tex+total)
    gross_total_label = Label(get_total_frame, text="Grand total:", font=("courier", 17))
    gross_total_label.place(x=740, y=15)
    gross_total_label_num = Label(get_total_frame,text=getTotal.gross_total, font=("courier", 17))
    gross_total_label_num.place(x=865, y=15,width=250)
    ...
    if (num > 0 and num <= 9):
        ...
        out = converter(int(number_in_string11[0]), hundredvalue=1) + converter(
            int(number_in_string11[1:3])) + " Crore " + converter(int(number_in_string11[3:5]),
                                                                  lakhvalue=1) + converter(int(number_in_string11[5:7]),
                                                                                           thousandvalue=1) + converter(
    ...
    total_word_label_num.place(x=100, y=50,width=700)
...
class PDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(55, 5, "Tex(Rs.)             : " + str(getTotal.total_tex), align='L', border=1)
        self.ln(5)
...
invoice_no_entry.place(x=190, y=35)
...
enter_tex_entry.place(x=190, y=95)
...
pro_name_entry.place(x=150, y=5, width=100)

hsn_lebel = Label(add_pro_frame, text="HSN code:", font=("courier", 17))
hsn_lebel.place(x=285, y=5)
...
rate_lebel.place(x=745, y=5)
rate_entry = Entry(add_pro_frame, textvariable=product_rate)
rate_entry.place(x=825, y=5, width=100)
...
rate_lebel = Label(print_frame, text="© Copyright Integer-i. All Rights Reserved", font=("courier",13),bg=frame_color)
